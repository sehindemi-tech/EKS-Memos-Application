...
| <a name="input_hosted_zone_arn"></a> [hosted\_zone\_arn](#input\_hosted\_zone\_arn) | Route 53 hosted zone ARN this project's DNS records live in | `string` | n/a | yes |
| <a name="input_kms_key"></a> [kms\_key](#input\_kms\_key) | KMS key ARN used to encrypt the RDS instance | `string` | n/a | yes |
...
| <a name="input_rds_secret_arn"></a> [rds\_secret\_arn](#input\_rds\_secret\_arn) | Secrets Manager ARN for the RDS master credentials | `string` | n/a | yes |
| <a name="input_subnet_ids"></a> [subnet\_ids](#input\_subnet\_ids) | Subnets the EKS control plane's ENIs get placed in | `list(string)` | n/a | yes |
