...
| <a name="input_grafana_admin_credentials_secret_arn"></a> [grafana\_admin\_credentials\_secret\_arn](#input\_grafana\_admin\_credentials\_secret\_arn) | The ARN of the Grafana admin credentials secret | `string` | n/a | yes |
