...
| Name | Type |
|------|------|
| [aws_s3_bucket.bootstrap_state](https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3_bucket) | resource |
...
| <a name="input_s3_buckets"></a> [s3\_buckets](#input\_s3\_buckets) | S3 Bucket settings | <pre>object({<br/>    bucket_settings = map(object({<br/>      name          = string<br/>      force_destroy = optional(bool, false)<br/>      description   = optional(string)<br/>    }))<br/>  })</pre> | n/a | yes |
